...
for device in devices:  # Retrives the first part of devices from backup.py
    devicedict[device[0] + "    " + device[1] + "   " + device[2]] = device
...
R3 = Radiobutton(backuptab, text="Other:", variable=radio_sel, value="")  # TODO get value from text box
